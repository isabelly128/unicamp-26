      ...
      <aside style={{
        ...
        <div style={{ padding: '28px 20px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div style={{
            ...
            color: 'rgba(240,237,228,0.35)', marginTop: '4px',
          }}>
            Here I Am, Lord
          </div>
          <div style={{
            fontSize: '10px', letterSpacing: '0.1em',
            color: 'rgba(212,230,0,0.5)', marginTop: '8px',
            fontFamily: "'Barlow Condensed', sans-serif",
        ...
        <nav style={{ flex: 1, padding: '16px 12px' }}>
          ...
          <div style={{
            ...
            color: 'rgba(240,237,228,0.2)', letterSpacing: '0.15em',
            paddingLeft: '10px',
            fontFamily: "'Barlow Condensed', sans-serif",
            textTransform: 'uppercase',
          }}>Quick Links</div>
          {QUICK_LINKS.map((link) => (
            <a
              ...
              onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.04)'; (e.currentTarget as HTMLElement).style.color = 'rgba(240,237,228,0.7)'; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.background = 'transparent'; (e.currentTarget as HTMLElement).style.color = 'rgba(240,237,228,0.4)'; }}
            >
