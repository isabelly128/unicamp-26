      ...
      <nav style={{
        ...
        <div style={{ display:'flex', alignItems:'stretch', width:'max-content' }}>
          ...
          <button onClick={logout} style={{
            ...
            <span style={{ fontFamily:"'Barlow Condensed',sans-serif", fontSize:'9px', fontWeight:700, letterSpacing:'0.06em', textTransform:'uppercase', color:'rgba(247,246,221,0.3)', marginTop:'3px', whiteSpace:'nowrap' }}>Sign Out</span>
          </button>
        </div>
      </nav>
