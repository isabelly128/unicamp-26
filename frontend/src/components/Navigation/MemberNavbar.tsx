    ...
    <>
      ...
      <aside style={{
        ...
        <div style={{ padding: '28px 20px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div style={{ marginTop:'10px', display:'inline-block', padding:'3px 10px', borderRadius:'100px', background:'rgba(247,246,221,0.1)', border:'1px solid rgba(247,246,221,0.2)', fontSize:'10px', fontWeight:700, letterSpacing:'0.1em', color:'#f7f6dd', textTransform:'uppercase', fontFamily:"'arial black regular',sans-serif" }}>
            Member
          </div>
        </div>
        ...
        <div style={{ padding:'16px 20px', borderTop:'1px solid rgba(255,255,255,0.06)' }}>
          <a href="/staff/login" style={{
            ...
            fontFamily:"'arial black regular',sans-serif", textDecoration:'none', transition:'color 0.15s',
          }}
      ...
      <nav style={{
        ...
        <div style={{ display:'flex', alignItems:'stretch', width:'max-content' }}>
          ...
          <a href="/staff/login" style={{
            ...
            <span style={{ fontFamily:"'arial black regular',sans-serif", fontSize:'9px', fontWeight:700, letterSpacing:'0.06em', textTransform:'uppercase', color:'rgba(247,246,221,0.45)', marginTop:'3px', whiteSpace:'nowrap' }}>Staff</span>
          </a>
        </div>
      </nav>
