  ...
  return (
    <div style={{ padding: '40px', maxWidth: '960px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <div style={{ fontSize: '11px', letterSpacing: '0.2em', color: '#D4E600', fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, textTransform: 'uppercase', marginBottom: '6px' }}>
          Camp 2024
        </div>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '12px', flexWrap: 'wrap', marginBottom: '8px' }}>
          <span style={{ ...heading, fontSize: '52px', color: '#F0EDE4', lineHeight: 0.9 }}>CAMP</span>
          <span style={{ fontFamily: "'Playfair Display', serif", fontStyle: 'italic', fontWeight: 700, fontSize: '42px', color: '#D4E600', lineHeight: 0.9 }}>Photos</span>
        </div>
        <p style={{ fontSize: '13px', color: 'rgba(240,237,228,0.4)', fontFamily: "'Barlow', sans-serif" }}>
        ...
        <>
          {filteredPhotos.length === 0 ? (
            <div style={{
              ...
              <div style={{ ...heading, fontSize: '28px', color: '#F0EDE4', marginBottom: '8px' }}>
                No photos yet
              </div>
              <p style={{ fontSize: '13px', color: 'rgba(240,237,228,0.35)', fontFamily: "'Barlow', sans-serif", marginBottom: '20px' }}>
                {canUpload
              ...
              <a
                ...
                style={{
                  ...
                  background: '#D4E600', borderRadius: '4px',
                ...
                >
                  ...
                  {photo.caption && (
                    <div style={{
                      ...
                      fontSize: '11px', color: 'rgba(240,237,228,0.8)',
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              color: '#F0EDE4', fontSize: '20px', width: '40px', height: '40px',
      ...
      {canUpload && (
        <div style={{
          ...
          border: '1px solid rgba(212,230,0,0.12)',
          borderRadius: '6px',
        }}>
          <div style={{ ...heading, fontSize: '14px', color: '#D4E600', marginBottom: '10px' }}>
            📋 How to add photos
          </div>
          <ol style={{ paddingLeft: '18px', fontSize: '13px', color: 'rgba(240,237,228,0.5)', fontFamily: "'Barlow', sans-serif", lineHeight: 2 }}>
            <li>Upload photos to the <a href={DRIVE_FOLDER_URL} target="_blank" rel="noopener noreferrer" style={{ color: '#D4E600' }}>shared Drive folder ↗</a></li>
