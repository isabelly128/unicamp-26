            ...
            {pendingConvictions.map((c: Conviction) => (
              <div key={c.id} className="pastoral-card">
                ...
                <div style={{ display:'flex', gap:'8px', flexShrink:0 }}>
                  ...
                  <button onClick={() => rejectConviction(c.id)} style={{ padding:'6px 10px', borderRadius:'4px', border:'none', background:'rgba(220,80,80,0.15)', color:'#e07070', fontSize:'11px', fontWeight:700, cursor:'pointer', fontFamily:"'Arial Black','Arial Bold',Gadget,sans-serif" }}>✕</button>
                </div>
              </div>
            ))}
          </div>
